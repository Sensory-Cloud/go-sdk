...
type EnrollmentServiceClient interface {
	...
	// Authorization metadata is required {"authorization": "Bearer <TOKEN>"}
	UpdateEnrollmentGroup(ctx context.Context, in *UpdateEnrollmentGroupRequest, opts ...grpc.CallOption) (*EnrollmentGroupResponse, error)
	// Removes a list of enrollments from an enrollment group
	// Authorization metadata is required {"authorization": "Bearer <TOKEN>"}
	RemoveEnrollmentsFromGroup(ctx context.Context, in *RemoveEnrollmentsRequest, opts ...grpc.CallOption) (*EnrollmentGroupResponse, error)
}
...
func (c *enrollmentServiceClient) UpdateEnrollment(ctx context.Context, in *UpdateEnrollmentRequest, opts ...grpc.CallOption) (*EnrollmentResponse, error) {
	out := new(EnrollmentResponse)
	err := c.cc.Invoke(ctx, "/sensory.api.v1.management.EnrollmentService/UpdateEnrollment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enrollmentServiceClient) UpdateEnrollmentGroup(ctx context.Context, in *UpdateEnrollmentGroupRequest, opts ...grpc.CallOption) (*EnrollmentGroupResponse, error) {
	out := new(EnrollmentGroupResponse)
	err := c.cc.Invoke(ctx, "/sensory.api.v1.management.EnrollmentService/UpdateEnrollmentGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *enrollmentServiceClient) RemoveEnrollmentsFromGroup(ctx context.Context, in *RemoveEnrollmentsRequest, opts ...grpc.CallOption) (*EnrollmentGroupResponse, error) {
	out := new(EnrollmentGroupResponse)
	err := c.cc.Invoke(ctx, "/sensory.api.v1.management.EnrollmentService/RemoveEnrollmentsFromGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EnrollmentServiceServer interface {
	...
	// Updates the name of an enrollment group
	// Authorization metadata is required {"authorization": "Bearer <TOKEN>"}
	UpdateEnrollmentGroup(context.Context, *UpdateEnrollmentGroupRequest) (*EnrollmentGroupResponse, error)
	// Removes a list of enrollments from an enrollment group
	// Authorization metadata is required {"authorization": "Bearer <TOKEN>"}
	RemoveEnrollmentsFromGroup(context.Context, *RemoveEnrollmentsRequest) (*EnrollmentGroupResponse, error)
...
func (UnimplementedEnrollmentServiceServer) UpdateEnrollment(context.Context, *UpdateEnrollmentRequest) (*EnrollmentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateEnrollment not implemented")
}
func (UnimplementedEnrollmentServiceServer) UpdateEnrollmentGroup(context.Context, *UpdateEnrollmentGroupRequest) (*EnrollmentGroupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateEnrollmentGroup not implemented")
}
func (UnimplementedEnrollmentServiceServer) RemoveEnrollmentsFromGroup(context.Context, *RemoveEnrollmentsRequest) (*EnrollmentGroupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveEnrollmentsFromGroup not implemented")
}
...
func _EnrollmentService_UpdateEnrollment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sensory.api.v1.management.EnrollmentService/UpdateEnrollment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EnrollmentService_UpdateEnrollmentGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateEnrollmentGroupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EnrollmentServiceServer).UpdateEnrollmentGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sensory.api.v1.management.EnrollmentService/UpdateEnrollmentGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnrollmentServiceServer).UpdateEnrollmentGroup(ctx, req.(*UpdateEnrollmentGroupRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EnrollmentService_RemoveEnrollmentsFromGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveEnrollmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EnrollmentServiceServer).RemoveEnrollmentsFromGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sensory.api.v1.management.EnrollmentService/RemoveEnrollmentsFromGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnrollmentServiceServer).RemoveEnrollmentsFromGroup(ctx, req.(*RemoveEnrollmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EnrollmentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _EnrollmentService_UpdateEnrollmentGroup_Handler,
		},
		{
			MethodName: "RemoveEnrollmentsFromGroup",
			Handler:    _EnrollmentService_RemoveEnrollmentsFromGroup_Handler,
		},
	},
